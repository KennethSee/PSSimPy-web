...
setup_customize_credit_facility_page = st.Page("setup/5_customize_credit_facility_agent.py",
                             title="Customize Credit Facility Agent",
                             icon=":material/currency_exchange:")
setup_preview_page = st.Page("setup/6_preview.py",
                             title="Preview",
...
pg = st.navigation(
    {
        ...
        "Setup": [setup_parameters_page, setup_input_page, setup_customize_agents_page, setup_customize_settlement_agent_page, setup_customize_credit_facility_page, setup_preview_page],
